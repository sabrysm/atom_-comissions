...
public class Paginator extends ListenerAdapter {
    protected static final Map<String, Paginator> paginators = new HashMap<>();
    ...
    protected boolean interactionCheck(ButtonInteractionEvent event) {
    ...
    protected void updatePage(ButtonInteractionEvent event, Paginator paginator) {
