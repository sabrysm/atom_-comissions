...
public class GuildUploadHelper {
    ...
    public GuildUploadHelper(String text, String guildName, long guildID, boolean isFile) throws Exception {
    ...
    public void uploadGuildUploadUsers() throws SQLException {
        ...
        if (manager.isGuildListExists(guildName, guildID)) {
            manager.removeGuildList(guildName, guildID);
        }
    ...
    public void addUsersToDatabase() throws SQLException {
        ...
        for (int i = 0; i < players.size(); i++) {
            ...
            if (playersBatch.size() == 40 || i == players.size() - 1) {
                ...
                try {
                    manager.uploadGuildList(guildName, playersBatch,guildID);
